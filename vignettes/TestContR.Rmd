...
Before you use this package you need to answer the following 2 questions:
 ...
 1. Do I want a randomized list of individuals or do I want the Top N observations for a list individuals that I already have?
...
**Expected data set layout with individuals/labels/names/id in the first column:**
...
### match_mixed(): Random Select of Test and Control groups/individuals with mixed metrics/variables, meaning both numeric and categorical.
